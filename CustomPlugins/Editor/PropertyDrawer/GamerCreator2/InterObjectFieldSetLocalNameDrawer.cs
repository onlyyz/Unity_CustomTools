...
{
    [CustomPropertyDrawer(typeof(FieldInterObjectSetLocalName))]
    public class InterObjectFieldSetLocalNameDrawer : PropertyDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            SerializedProperty game = property.FindPropertyRelative("m_State");
            //Bool
